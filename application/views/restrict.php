		...
		<div class="row">
			...
			<div class="container">
				<ul class="nav nav-tabs">
					<li class="active"><a href="#tab_services" role="tab" data-toggle="tab">Serviços</a></li>	
					<li><a href="#tab_team" role="tab" data-toggle="tab">Equipe</a></li>
					<li><a href="#tab_user" role="tab" data-toggle="tab">Usuários</a></li>
				</ul>

				<div class="tab-content">
					<div id="tab_services" class="tab-pane active">
						<div class="container-fluid">
							<h2 class="text-center"><strong>Gerenciar Serviços</strong></h2>
						<a id="btn_add_service" class="btn btn-primary"><i class="fa fa-plus">&nbsp;&nbsp;Adicionar Serviços</i></a>
					...
					<div id="tab_team" class="tab-pane"><div id="tab_services" class="tab-pane active">
						<div class="container-fluid">
						...
						<table id="dt-team" class="table table-striped table-bordered">
							<thead>
								<tr class="tableheader">
									<th class="dt-center">Nome</th>
					...
					<div id="tab_user" class="tab-pane"><div id="tab_services" class="tab-pane active">
						<div class="container-fluid">
			...
			<div class="modal-body">
				<form id="form_service">
					...
					<div class="form-group text-center">
						<button type="submit" id="btn_save_services" class="btn btn-primary">
